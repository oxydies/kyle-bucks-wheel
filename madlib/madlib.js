...
// EXACTLY 40 templates (indexes 0-39) - matches API
const templates = [
    // 0-4: Office chaos
    ...
    // 38-39: Pure chaos (only 2 to make 40 total)
...
console.log('Total templates loaded:', templates.length); // Should be 40
...
function loadNewPrompts() {
    ...
    // Pick random template index (0 to 39)
...
console.log('✅ MADLIB SCRIPT LOADED - 40 templates ready!');
